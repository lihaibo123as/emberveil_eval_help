...
function EVAL_SHARE_SEAL_VARIANT_PROBE()
  ...
  --   [1] A 行原样（自定义头衔色 + 头衔 + |r + 名 + 分享了）   [2] 同 A 但换成**品阶色**（隔离「自定义头衔色」这个变量）
  --   [3] 只有 色码+头衔+重置   [4] A 行但**不带任何色码**   [5] A 行但头衔带方括号   [6] 最简纯文本
  --   [7] 色码**包住整行**（中间不复位）   [8] A 行但去掉「分享了」三个字
  --   [9] 现已验证能显示的 B 行（对照，必须出现）   [10] 纯文本对照
  local vs = {
    "[1] A行原样：" .. TITLE_COL .. title .. "|r " .. who .. " 分享了",
    "[2] A行 · 换品阶色：" .. TIER_COL .. title .. "|r " .. who .. " 分享了",
    "[3] 只色码+头衔+复位：" .. TITLE_COL .. title .. "|r",
    "[4] A行 · 无色码：" .. title .. " " .. who .. " 分享了",
    "[5] A行 · 头衔带方括号：" .. TITLE_COL .. "[" .. title .. "]|r " .. who .. " 分享了",
    "[6] 最简纯文本：" .. who .. " 分享了",
    "[7] 色码包整行：" .. TITLE_COL .. title .. " " .. who .. " 分享了|r",
    "[8] A行 · 去掉「分享了」：" .. TITLE_COL .. title .. "|r " .. who,
    "[9] 现用 B 行（对照·必须出现）：" .. sFull,
    "[10] 纯文本等长填充：" .. string.rep("X", 100),
  }
  ...
  shSay("  1 A行原样 · 2 A行换品阶色 · 3 只色码+头衔 · 4 A行无色码 · 5 A行头衔带括号 · 6 最简纯文本 · 7 色码包整行 · 8 A行去掉「分享了」 · 9 现用B行(对照) · 10 纯文本")
  return probe
end
