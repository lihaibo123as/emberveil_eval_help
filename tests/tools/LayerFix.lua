...
do
  ...
  TEST.chat = ""
  EVAL_TEST_FIRE_UPDATE(tickF223, LIM223.period) -- dt = 一个周期 = 正好一轮（走真机通道：全局 arg1）
  eq(tstate223[5] == false and tstate223[6] == false, true,
  ...
  EVAL_TEST_FIRE_UPDATE(tickF223, LIM223.period)
  eq(tstate223[5] == false and tstate223[6] == false, true,
  ...
  for _i = 1, LIM223.checks + 2 do
    if EVAL_TEST_FIRE_UPDATE(tickF223, LIM223.period) then fired223 = fired223 + 1 end
  end
