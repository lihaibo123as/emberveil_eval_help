...
do
  ...
  for _i = 1, LIM.checks + 2 do
    if EVAL_TEST_FIRE_UPDATE(tick204, LIM.period) then fired204 = fired204 + 1 end
  end
  ...
  EVAL_TEST_FIRE_UPDATE(tick204, LIM.period)
  ...
  TEST.chat = ""
  eq(type(tick204:GetScript("OnUpdate")) == "function", true, "组204③b前置：拿到真实 OnUpdate 脚本")
  EVAL_TEST_FIRE_UPDATE(tick204, LIM.wall + 1)
...
do
  ...
  if type(upd8) == "function" then
    for _ = 1, lim8.tries + 2 do EVAL_TEST_FIRE_UPDATE(rf8, lim8.period + 0.01) end
  end
  eq(EVAL_DF_TEST_STATE().rosterLeft, 0, "组208⑤★★★ 跟满次数后自动归零（有界，不是常驻轮询）")
  local doneBefore8 = EVAL_DF_TEST_STATE().rosterDone
  if type(upd8) == "function" then
    for _ = 1, 3 do EVAL_TEST_FIRE_UPDATE(rf8, lim8.period + 0.01) end
  end
...
do
  ...
  for _ = 1, 6 do if mv212 then EVAL_TEST_FIRE_UPDATE(iconBtn212, 0.05) end end
  if up212 then pcall(up212, "LeftButton") end
...
do
  ...
  for _ = 1, 6 do if mv215 then EVAL_TEST_FIRE_UPDATE(h215.btn, 0.05) end end
...
do
  ...
  for _ = 1, 6 do if type(mv216) == "function" then EVAL_TEST_FIRE_UPDATE(icon216, 0.05) end end
  if type(upL216) == "function" then pcall(upL216, icon216, "LeftButton") end
...
do
  ...
  local function dragBy217(dx, dy)
    ...
    for _ = 1, 8 do if type(mv217) == "function" then EVAL_TEST_FIRE_UPDATE(h217, 0.05) end end
...
do
  ...
  for _ = 1, 8 do if type(mv221) == "function" then EVAL_TEST_FIRE_UPDATE(h221, 0.05) end end
...
do
  ...
  for _ = 1, 8 do if type(mv222) == "function" then EVAL_TEST_FIRE_UPDATE(h222, 0.05) end end
