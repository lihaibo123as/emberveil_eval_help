...
| :-- | :-- | :-- |
| **1.74.1** | 🖱 Правки условий меню группы + выход | «Пригласить» теперь видно, если не в группе **или** вы лидер (исправлено: лидер не мог звать) · «Исключить» требует лидерства + цель — член группы · новое «Покинуть группу» (видно в группе) · скриншоты синхронизированы (2 устаревших убраны + раздел питомцев) |
