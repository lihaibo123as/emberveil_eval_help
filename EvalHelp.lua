-- EvalHelp 1.67.2 —— 全职业施法工具：通用一键宏（条件规则引擎） + 状态日志 + 战斗信息UI + 配置窗口
...
EVAL_IO_TEMPLATES = {
  ...
  { cls = "盗贼", list = {
    { name = "盗贼一键", desc = "邪恶攻击攒星（能量>70）/剔骨终结（满5星；自身血<30 时 4 星即收）", text = "# 方案: 盗贼一键\n\n" ..
      "- 邪恶攻击 | 能量>70\n" ..
      "- 剔骨 | 能量>50 & 连击>4 & 自身血<30\n" ..
      "- 剔骨 | 能量>50 & 连击>=5" },
  }},
}
